 ...
 * @retval -ENOMEM if creating RMT TX channel failed because out of memory, or all RMT channels are used up and no more free one.
 * @retval -ENODEV if creating RMT TX channel failed because some feature is not supported by hardware, e.g. DMA feature is not supported by hardware, or other error.
 */
 ...
 * @retval -ENODEV Transmit data failed because channel is not enabled, or some feature is not supported by hardware, e.g. unsupported loop count, or other error.
 */
 ...
 * @retval -ENOMEM Create sync manager failed because out of memory, or all sync controllers are used up and no more free one.
 * @retval -ENODEV Create sync manager failed because it is not supported by hardware, or not all channels are enabled, or other error.
 */
