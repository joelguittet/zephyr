...
typedef struct
{
	/**< The number of transmitted RMT symbols, including one EOF symbol, which is appended by the driver to mark the end of a transmission.
 ...
 * @param edata Point to RMT event data. The lifecycle of this pointer memory is inside this function,
