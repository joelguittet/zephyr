 ...
 * @retval -ENODEV Create RMT RX channel failed because all RMT channels are used up and no more free one, or some feature is not supported by hardware, e.g. DMA feature is not supported by hardware, or other error.
 */
